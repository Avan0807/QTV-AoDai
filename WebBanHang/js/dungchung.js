	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                ...
                <a href="https://www.google.com.vn/?hl=vi" class="fa fa-google"></a>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="game.html"><i class="fa fa-info-circle"></i> Tích Điểm</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/products/LogoMoiCapNhat.png" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">QTV AoDai VietNam</a> - All rights reserved © 2024 - Designed by
            <span style="color: #eee; font-weight: bold">group 2nd</span></p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ đổi trả sản phẩm lỗi</li>
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0967999999" style="color: #288ad6;">0967999999</a>
                </li>
            </ul>
        </section>
    </div>`);
