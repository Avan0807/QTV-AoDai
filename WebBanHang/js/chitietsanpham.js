...
function phanTich_URL_chiTietSanPham() {
 ...
 if(!nameProduct) return khongTimThaySanPham();
    ...
    var s = addThongSo('Cổ áo', decodeURIComponent(encodeURIComponent(sanPhamHienTai.detail.Cổ_áo)));
    s += addThongSo('Thân áo',decodeURIComponent(encodeURIComponent( sanPhamHienTai.detail.Thân_áo)));
    s += addThongSo('Tà trước',decodeURIComponent(encodeURIComponent( sanPhamHienTai.detail.Tà_trước)));
    s += addThongSo('Tà sau',decodeURIComponent(encodeURIComponent( sanPhamHienTai.detail.Tà_sau)));
    s += addThongSo('Tay áo',decodeURIComponent(encodeURIComponent(sanPhamHienTai.detail.Tay_áo)));
    s += addThongSo('Ống tay',decodeURIComponent(encodeURIComponent(sanPhamHienTai.detail.Ống_tay)));
    s += addThongSo('Loại vải',decodeURIComponent(encodeURIComponent( sanPhamHienTai.detail.Loại_vải)));
    s += addThongSo('Size',decodeURIComponent(encodeURIComponent( sanPhamHienTai.detail.Size)));
    s += addThongSo('Đường may',decodeURIComponent(encodeURIComponent( sanPhamHienTai.detail.Đường_may)));
    info.innerHTML = s;
    console.log(decodeURIComponent(encodeURIComponent( sanPhamHienTai.detail.size)))
    // Cập nhật hình
...
function getDetailPromo(sp) {
    switch (sp.promo.name) {
        ...
        case 'moiramat':
            return `Khách hàng sẽ được thử đồ miễn phí tại cửa hàng.`;
